...
const sizes = {
  smSrc: "lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px]",
  sm: "lg:pb-[14px] xl:pb-[16px] pb-[19px] 3xl:pb-[22px] lg:pt-[11px] xl:pt-[13px] pt-[15px] 3xl:pt-[18px] lg:px-[11px] xl:px-[13px] px-[15px] 3xl:px-[18px]",
  md: "lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px]",
  lg: "lg:px-[17px] xl:px-[20px] px-[23px] 3xl:px-[27px] lg:py-[18px] xl:py-[21px] py-[24px] 3xl:py-[28px]",
};
