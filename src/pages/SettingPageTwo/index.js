        ...
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="items-center w-[83%]">
            ...
            <Column className="bg-white_A700 justify-end lg:mt-[24px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] lg:p-[23px] xl:p-[26px] 2xl:p-[30px] 3xl:p-[36px] rounded-radius25 w-[93%]">
              <Row className="lg:ml-[12px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] mr-[auto] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[37%]">
                <Text className="font-medium lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_400 w-[auto]">
                  Edit Profile
                </Text>
                <Column className="items-center lg:ml-[47px] xl:ml-[54px] 2xl:ml-[61px] 3xl:ml-[73px] w-[31%]">
                  <Text className="font-medium lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-indigo_600 w-[auto]">
                    Preferences
                  </Text>
                  <Line className="bg-indigo_600 h-[3px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] rounded-bl-[0] rounded-br-[0] rounded-tl-[10px] rounded-tr-[10px] w-[96%]" />
                </Column>
                <Text className="font-medium lg:ml-[47px] xl:ml-[54px] 2xl:ml-[61px] 3xl:ml-[73px] mt-[1px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_400 w-[auto]">
                  Security
                </Text>
              </Row>
              <Column className="w-[100%]">
                <Line className="bg-gray_300 h-[1px] w-[100%]" />
                <Row className="items-center justify-evenly lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[100%]">
                  <Column className="w-[51%]">
                    ...
                    <Input
                      ...
                      wrapClassName="2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] w-[94%] xl:mt-[8px]"
                      name="price"
                      placeholder="USD"
                      size="sm"
                    ></Input>
                ...
                <Text className="font-medium lg:mt-[22px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] lg:text-[13px] xl:text-[15px] 2xl:text-[17px] 3xl:text-[20px] text-bluegray_900 w-[auto]">
                  Notification
                </Text>
                ...
                <Row className="items-center lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[25%]">
                  <Switch value={false} className="w-[21%]" />
                  <Text className="font-normal lg:ml-[16px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] not-italic lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_400 w-[auto]">
                    I receive merchant order
                  </Text>
                </Row>
                <Row className="items-center lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[38%]">
                ...
                <Button
                  className="font-medium 3xl:ml-[1032px] lg:ml-[668px] xl:ml-[765px] 2xl:ml-[860px] lg:mt-[56px] xl:mt-[64px] 2xl:mt-[72px] 3xl:mt-[86px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[18%]"
